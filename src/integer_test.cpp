...
TEST(IntTest, Mod) {
  const Int j{
      ...
      "37205668069673"};
  const Int k{"1267650600228229401496703205653"};
  const Int m{"2659485890900719634874946"};
  EXPECT_EQ(j.mod(k), m);

  const Int a{"1267650600228229401496703205376"};
  const Int b{"1267650600228229401496703205653"};
  EXPECT_EQ(b.mod(a), 277);
}

TEST(IntTest, Print) {
  const Int a{"0"};
  EXPECT_TRUE(a.print() == "0");

  const Int b{"-0"};
  EXPECT_TRUE(b.print() == "0");

  const Int c{"100"};
  EXPECT_TRUE(c.print() == "100");

  const Int d{"-100"};
  EXPECT_TRUE(d.print() == "-100");

  const Int e{"4294967295"};
  EXPECT_TRUE(e.print() == "4294967295");

  const Int f{"-4294967295"};
  EXPECT_TRUE(f.print() == "-4294967295");

  const Int g{"4294967296"};
  EXPECT_TRUE(g.print() == "4294967296");

  const Int h{"-4294967296"};
  EXPECT_TRUE(h.print() == "-4294967296");
  ...
  const Int k{"18446744073709551616"};
  EXPECT_TRUE(k.print() == "18446744073709551616");

  const Int l{"-18446744073709551616"};
  EXPECT_TRUE(l.print() == "-18446744073709551616");

  const Int m{"79228162514264337593543950336"};
  EXPECT_TRUE(m.print() == "79228162514264337593543950336");

  const Int n{"-79228162514264337593543950336"};
  EXPECT_TRUE(n.print() == "-79228162514264337593543950336");
}
